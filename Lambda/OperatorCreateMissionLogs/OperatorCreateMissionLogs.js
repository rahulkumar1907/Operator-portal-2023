...
exports.handler = (event, context, callback) => {
    ...
    wf.once('check_request_body', function () {
        ...
        // Mission.data = event.body.hasOwnProperty('data') == true ? event.body.data.length == 0 ? event.body.data = '' : event.body.data : '';
        ...
        // if (Mission.data.length == 0) { parameters = parameters + 'data/' }
