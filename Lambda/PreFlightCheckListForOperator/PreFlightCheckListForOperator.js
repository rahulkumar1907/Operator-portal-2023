...
exports.handler = (event, context, callback) => {
    ...
    wf.once('check_request_body', function () {
        ...
        if (parameters.length > 1) {
            ...
            wf.emit('update_flight_table');
        }

    })

    wf.once("update_flight_table", function () {
        const params = {
            TableName: "Flight",
            Key: {
                "FlightId": event.body.FlightId,
    ...
    wf.once('get_Flight_details', function () {
        const params = {
            TableName: process.env.FlightTable,
        ...
        docClient.get(params, function (err, data) {
            if (err) {
                ...
                wf.emit('store_preFlight_check_List')
            }
        })
    })

    wf.once('store_preFlight_check_List', function () {
    ...
    wf.once('send_email', function () {
        //   wf.TemplateData = "{ \"DroneName\":\""+event.body.DroneName+"\", \"OperationNameState\":\""+event.body.OperationNameState+"\",\"PhysicalCheckOfAirFrame\":\""+event.body.PhysicalCheckOfAirFrame+"\", \"FlightId\":\""+event.body.FlightId+"\",\"OperatorName\":\""+event.body.OperatorName+"\", \"OperatorId\":\""+event.body.OperatorId+"\", \"AssemblyOfAirCraft\":\""+event.body.AssemblyOfAirCraft+"\", \"CheckCG\":\""+event.body.CheckCG+"\", \"LogInSkyeUtmAndScheduleFlight\":\""+event.body.LogInSkyeUtmAndScheduleFlight+"\", \"PreFlightCallibration\":\""+event.body.PreFlightCallibration+"\", \"PowerTheDrone\":\""+event.body.PowerTheDrone+"\", \"ConnectToMissionPlanner\":\""+event.body.ConnectToMissionPlanner+"\", \"Callibration\":\""+event.body.Callibration+"\", \"TXModeBeforeTakeOff\":\""+event.body.TXModeBeforeTakeOff+"\", \"SkyeUtmStartMission\":\""+event.body.SkyeUtmStartMission+"\", \"ConfirmationBeforeTakeOff\":\""+event.body.ConfirmationBeforeTakeOff+"\", \"FlightWayDetails\":\""+event.body.FlightWayDetails+"\", \"PowerOfUAV\":\""+event.body.PowerOfUAV+"\", \"WeatherStatus\":\""+event.body.WeatherStatus+"\", \"ComponentConnectorsCheck\":\""+event.body.ComponentConnectorsCheck+"\"}";
        // wf.TemplateData = JSON.stringify({
        //     DroneName: event.body.DroneName,
        //     OperationNameState: event.body.OperationNameState,
        //     PhysicalCheckOfAirFrame: event.body.PhysicalCheckOfAirFrame,
        //     FlightId: event.body.FlightId,
        //     OperatorName: event.body.OperatorName,
        //     OperatorId: event.body.OperatorId,
        //     AssemblyOfAirCraft: event.body.AssemblyOfAirCraft,
       ...
       wf.TemplateData = JSON.stringify({
        ...
        // wf.TemplateData = "{ \"ApproveLink\":\"" + ApproveLink + "\" }";
        ...
        var params = {
            ...
            "Destination": {
                ...
                "CcAddresses": ["animesh@skyeair.tech"],
                "BccAddresses": []
            },
